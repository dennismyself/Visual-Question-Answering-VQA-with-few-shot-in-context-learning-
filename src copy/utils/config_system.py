...
def process_config(args):
    ...
    # Some mapping from args to configs defined specifically for this project
    if args.num_shots != -1:
    ...
    if config.data_loader.dataset_modules.module_dict.get('LoadInContextExamples', None) is not None:
